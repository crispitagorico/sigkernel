...
class EncoderRNN(torch.nn.Module):
    ...
    def init_hidden(self,device):
        ...
        return torch.zeros(self.num_grulstm_layers, self.batch_size, self.hidden_size, 
...
class Net_GRU(nn.Module):
    ...
    def forward(self, x):
        ...
        outputs = torch.zeros([x.shape[0], self.target_length, x.shape[2]], dtype=torch.double).to(self.device)
